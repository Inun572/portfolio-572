...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-col items-center gap-y-4 w-full h-max bottom-0 top-0 mt-auto z-50 xl:justify-center xl:right-[2%] xl:w-16 xl:max-w-md xl:h-screen fixed">
      {/* {inner} */}
      <div className="flex w-full h-[80px] justify-evenly items-center xl:flex-col xl:justify-center gap-y-10 px-4 py-8 text-3xl md:px-40 xl:px-0 xl:h-max xl:text-xl xl:rounded-full bg-white/10 backdrop-blur-sm ">
